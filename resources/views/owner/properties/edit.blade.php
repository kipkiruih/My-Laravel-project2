...
<div class="container">
    <div class="card shadow-sm p-4">
        <h3 class="text-primary"><i class="fas fa-edit"></i> Edit Property</h3>
        <hr>
        ...
        <form action="{{ route('owner.properties.update', $property->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control border-secondary" value="{{ old('title', $property->title) }}" required>
            </div>

            <!-- Property Location -->
            <div class="mb-3">
                <label class="form-label text-dark"><i class="fas fa-map-marker-alt"></i> Location</label>
                <input type="text" name="location" class="form-control border-secondary" value="{{ old('location', $property->location) }}" required>
            </div>

            <!-- Property Price -->
            <div class="mb-3">
                <label class="form-label text-dark"><i class="fas fa-dollar-sign"></i> Price (Ksh)</label>
                <input type="number" name="price" class="form-control border-secondary" value="{{ old('price', $property->price) }}" required>
            </div>

            <!-- Property Description -->
            <div class="mb-3">
                <label class="form-label text-dark"><i class="fas fa-align-left"></i> Description</label>
                <textarea name="description" class="form-control border-secondary" rows="4" required>{{ old('description', $property->description) }}</textarea>
            </div>
             <!-- Property Type -->
             <div class="mb-3">
            ...
            @if($property->image)
            <div class="mb-3">
                <label class="form-label text-dark"><i class="fas fa-image"></i> Current Image</label><br>
            ...
            <div class="mb-3">
                <label class="form-label text-dark"><i class="fas fa-camera"></i> Change Image</label>
